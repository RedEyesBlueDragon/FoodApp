...
public class DesertFragment extends Fragment {
    ...
    private DesertViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mAdapter = new DataAdapter(getActivity() ,DataBaseHelper.getCategoryData(myDB,"Dessert"));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(DesertViewModel.class);
